 ...
 * - 422 payload fora do contrato (entra nas tarefas 4.x)
 */
@RestController
public class PreviewController {
    ...
    public PreviewController(PipelineDeRender pipeline) {
        this.pipeline = pipeline;
    }

    /**
     * @param format `pdf` (default) ou `png`
     * @param page   página do PNG (0-based; extensão pragmática do contrato da
     *               RFC para o preview paginado do designer)
     */
    public record PreviewRequest(String jrxml, Map<String, Object> sampleData, String format, Integer page) {}
